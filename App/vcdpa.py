...
MERGE (sec:Section {regional_standard_and_regulation_id: 'vcdpa', section_id: row.section_id})
ON CREATE SET
...
enforcement_action = """
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MERGE (ea:EnforcementAction {regional_standard_and_regulation_id: 'vcdpa', enforcement_id: row.enforcement_id})
ON CREATE SET
    ea.type = row.type,
...
implementation_spec = """
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MERGE (ispec:ImplementationSpec {regional_standard_and_regulation_id: 'vcdpa', impl_id: row.impl_id})
ON CREATE SET
...
control = """
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MERGE (co:Control {regional_standard_and_regulation_id: 'vcdpa', control_id: row.control_id})
ON CREATE SET
    co.name = row.name,
...
system = """
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MERGE (sy:System {regional_standard_and_regulation_id: 'vcdpa', system_id: row.system_id})
ON CREATE SET
    sy.name = row.name,
    sy.type = row.type,
...
process ="""
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MERGE (pro:Process {regional_standard_and_regulation_id: 'vcdpa', process_id: row.process_id})
ON CREATE SET
    pro.name = row.name,
...
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MERGE (efr:ExternalFrameworkRequirement {regional_standard_and_regulation_id: 'vcdpa', external_id: row.external_id})
ON CREATE SET
...
Threshold = """
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MERGE (th:Threshold {regional_standard_and_regulation_id: 'vcdpa', threshold_id: row.threshold_id})
ON CREATE SET
    th.type = row.type,
    th.name = row.name,
...
Exemption ="""
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MERGE (ex:Exemption {regional_standard_and_regulation_id: 'vcdpa', exemption_id: row.exemption_id})
ON CREATE SET
    ex.type = row.type,
    ex.name = row.name,
...
section_requirement = """
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (sec:Section {regional_standard_and_regulation_id: 'vcdpa',section_id : row.section_id})
...
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (req:Requirement {regional_standard_and_regulation_id: 'vcdpa', requirement_id: row.requirement_id})
MATCH (ro:Role {regional_standard_and_regulation_id: 'vcdpa', role_id: row.role_id})
...
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (req:Requirement {regional_standard_and_regulation_id: 'vcdpa', requirement_id: row.requirement_id})
MATCH (dc:DataCategory {regional_standard_and_regulation_id: 'vcdpa', data_id: row.data_id})
...
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (req:Requirement {regional_standard_and_regulation_id: 'vcdpa', requirement_id: row.requirement_id})
MATCH (et:EventType {regional_standard_and_regulation_id: 'vcdpa', event_type_id: row.event_type_id})
...
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (ro:Role {regional_standard_and_regulation_id: 'vcdpa', role_id: row.role_id})
MATCH (th:Threshold {regional_standard_and_regulation_id: 'vcdpa', threshold_id: row.threshold_id})
...
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (ro:Role {regional_standard_and_regulation_id: 'vcdpa', role_id: row.role_id})
MATCH (ex:Exemption {regional_standard_and_regulation_id: 'vcdpa', exemption_id: row.exemption_id})
...
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (req:Requirement {regional_standard_and_regulation_id: 'vcdpa', requirement_id: row.requirement_id})
MATCH (pol:Policy {regional_standard_and_regulation_id: 'vcdpa', policy_id: row.policy_id})
...
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (req:Requirement {regional_standard_and_regulation_id: 'vcdpa', requirement_id: row.requirement_id})
MATCH (co:Control {regional_standard_and_regulation_id: 'vcdpa', control_id: row.control_id})
...
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (co:Control {regional_standard_and_regulation_id: 'vcdpa', control_id: row.control_id})
MATCH (sy:System {regional_standard_and_regulation_id: 'vcdpa', system_id: row.system_id})
...
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (req:Requirement {regional_standard_and_regulation_id: 'vcdpa', requirement_id: row.requirement_id})
MATCH (pro:Process {regional_standard_and_regulation_id: 'vcdpa', process_id: row.process_id})
...
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (req:Requirement {regional_standard_and_regulation_id: 'vcdpa', requirement_id: row.requirement_id})
MATCH (dpa:DataProtectionAssessment {regional_standard_and_regulation_id: 'vcdpa', dpa_id: row.dpa_id})
MERGE (req)-[:REQUIREMENT_REQUIRES_DPA {trigger: row.trigger}]->(dpa);
"""
#DPA → Systems
dpa_systems = """
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (dpa:DataProtectionAssessment {regional_standard_and_regulation_id: 'vcdpa', dpa_id: row.dpa_id})
MATCH (sy:System {regional_standard_and_regulation_id: 'vcdpa', system_id: row.system_id})
MERGE (dpa)-[:DPA_ASSESSES_SYSTEM]->(sy);
"""
#DPA → Processes
dpa_process ="""
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (dpa:DataProtectionAssessment {regional_standard_and_regulation_id: 'vcdpa', dpa_id: row.dpa_id})
MATCH (pro:Process {regional_standard_and_regulation_id: 'vcdpa', process_id: row.process_id})
MERGE (dpa)-[:DPA_ASSESSES_PROCESS]->(pro);
"""
#Requirement → EnforcementAction
requirement_enforcementaction = """
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (req:Requirement {regional_standard_and_regulation_id: 'vcdpa', requirement_id: row.requirement_id})
MATCH (ea:EnforcementAction {regional_standard_and_regulation_id: 'vcdpa', enforcement_id: row.enforcement_id})
...
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (proc:Role {regional_standard_and_regulation_id: 'vcdpa', role_id: row.processor_role_id})
MATCH (ctrl:Role {regional_standard_and_regulation_id: 'vcdpa', role_id: row.controller_role_id})
...
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (proc:Role {regional_standard_and_regulation_id: 'vcdpa', role_id: row.processor_role_id})
MATCH (subproc:Role {regional_standard_and_regulation_id: 'vcdpa', role_id: row.subcontractor_role_id})
...
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (req:Requirement {regional_standard_and_regulation_id: 'vcdpa', requirement_id: row.source_requirement_id})
MATCH (efr:ExternalFrameworkRequirement {regional_standard_and_regulation_id: 'vcdpa', external_id: row.target_external_id})
