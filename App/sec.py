...
ON CREATE SET 
    ...
    dp.maxDelayDays = toInteger(row.maxDelayDays),
...
ON CREATE SET 
    ...
    re.complianceDate = date(row.complianceDate);
"""
...
ON CREATE SET 
    ...
    xbrl.effectiveDate = date(row.effectiveDate);
"""
...
regulated_entity_exemption_key_management_roles = """
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (re:RegulatedEntity {entityType: row.entityType})
...
regulated_entity_exemption_assessment_teams = """
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (re:RegulatedEntity {entityType: row.entityType})
...
regulated_entity_exemption_processes = """
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (re:RegulatedEntity {entityType: row.entityType})
...
regulated_entity_exemption_compliance_deadlines = """
LOAD CSV WITH HEADERS FROM '$file_path' AS row
MATCH (re:RegulatedEntity {entityType: row.entityType})
...
MATCH (reg:RegionalStandardAndRegulation {regional_standard_regulation_id: 'SEC-2023'})
MATCH (it:IncidentType {region_standard_regulation_id: 'SEC-2023'})
...
client.query(sec_disclosure_category.replace('$file_path',""))
time.sleep(2)

client.query(sec_disclosure_requirement.replace('$file_path',""))
time.sleep(2)

client.query(sec_regulatory_form.replace('$file_path',""))
time.sleep(2)

client.query(sec_filing_timeline.replace('$file_path',""))
time.sleep(2)

client.query(sec_delay_provision.replace('$file_path',""))
time.sleep(2)

client.query(sec_regulated_entity.replace('$file_path',""))
time.sleep(2)

client.query(sec_governance_body.replace('$file_path',""))
time.sleep(2)

client.query(sec_board_committee_type.replace('$file_path',""))
time.sleep(2)

client.query(sec_management_role.replace('$file_path', ""))
time.sleep(2)

client.query(sec_external_actor.replace('$file_path',""))
time.sleep(2)

client.query(sec_cybersecurity_incident.replace('$file_path',""))
time.sleep(2)

client.query(sec_material_cybersecurity_ncident.replace('$file_path',""))
time.sleep(2)

client.query(sec_information_system.replace('$file_path',""))
time.sleep(2)

client.query(sec_incident_type.replace('$file_path',""))
time.sleep(2)

client.query(sec_impact_category.replace('$file_path',""))
time.sleep(2)

client.query(sec_risk_management_process.replace('$file_path',""))
time.sleep(2)

client.query(sec_cybersecurity_framework.replace('$file_path',""))
time.sleep(2)

client.query(sec_security_control.replace('$file_path',""))
time.sleep(2)

client.query(sec_expertise.replace('$file_path',""))
time.sleep(2)

client.query(sec_board_oversight_process.replace('$file_path',""))
time.sleep(2)

client.query(sec_filing_event.replace('$file_path',""))
time.sleep(2)

client.query(sec_xbrl_tagging.replace('$file_path',""))
time.sleep(2)

client.query(sec_compliance_deadline.replace('$file_path',""))
time.sleep(2)

client.query(sec_exemption.replace('$file_path',""))
time.sleep(2)

client.query(sec_materiality_determination.replace('$file_path',""))
time.sleep(2)


client.query(sec_assessment_standard.replace('$file_path',""))
time.sleep(2)


client.query(sec_quantitative_factor.replace('$file_path',""))
time.sleep(2)

client.query(sec_qualitative_factor.replace('$file_path',""))
time.sleep(2)


client.query(sec_assessment_team.replace('$file_path',""))
time.sleep(2)


# Relationships
client.query(regulation_disclosure_category.replace('$file_path',""))
time.sleep(2)



client.query(regulation_disclosure_requirement.replace('$file_path',""))
time.sleep(2)


client.query(requirement_regulatory_form.replace('$file_path',""))
time.sleep(2)


client.query(regulatory_form_timeline.replace('$file_path',""))
time.sleep(2)


client.query(regulatory_form_delay.replace('$file_path',""))
time.sleep(2)

client.query(regulatory_form_xbrl.replace('$file_path',""))
time.sleep(2)


client.query(regulated_entity_regulation.replace('$file_path',""))
time.sleep(2)


client.query(regulated_entity_exemption.replace('$file_path',""))
time.sleep(2)

client.query(governance_body_type.replace('$file_path',""))
time.sleep(2)


client.query(management_role_governance_body.replace('$file_path',""))
time.sleep(2)

client.query(management_role_expertise.replace('$file_path',""))
time.sleep(2)


client.query(assessment_team_management_role.replace('$file_path', ""))
time.sleep(2)


client.query(regulated_entity_information_system.replace('$file_path', ""))
time.sleep(2)

client.query(requirement_risk_process.replace('$file_path', ""))
time.sleep(2)

client.query(risk_process_framework.replace('$file_path', ""))
time.sleep(2)

client.query(risk_process_control.replace('$file_path', ""))
time.sleep(2)

client.query(governance_body_oversight.replace('$file_path', ""))
time.sleep(2)

client.query(incident_incident_type.replace('$file_path', ""))
time.sleep(2)   

client.query(incident_information_system.replace('$file_path', ""))
time.sleep(2)

client.query(incident_impact_category.replace('$file_path', ""))
time.sleep(2)

client.query(materiality_determination_incident.replace('$file_path', ""))
time.sleep(2)

client.query(materiality_determination_standard.replace('$file_path', ""))
time.sleep(2)

client.query(assessment_standard_quantitative.replace('$file_path', ""))
time.sleep(2)

client.query(assessment_standard_qualitative.replace('$file_path', ""))
time.sleep(2)

client.query(assessment_team_determination.replace('$file_path', ""))
time.sleep(2)

client.query(determination_material_incident.replace('$file_path', ""))
time.sleep(2)

client.query(regulation_anchor_incident_types.replace('$file_path', ""))
time.sleep(2)

client.query(regulation_anchor_impact_categories.replace('$file_path', ""))
time.sleep(2)

client.query(regulation_anchor_expertise_requirements.replace('$file_path', ""))
time.sleep(2)

client.query(regulation_anchor_assessment_standards.replace('$file_path', ""))
time.sleep(2)

client.query(regulated_entity_exemption_board.replace('$file_path', ""))
time.sleep(2)

client.query(regulated_entity_exemption_key_management_roles.replace('$file_path', ""))
time.sleep(2)

client.query(regulated_entity_exemption_assessment_teams.replace('$file_path', ""))
time.sleep(2)

client.query(regulated_entity_exemption_processes.replace('$file_path', ""))
time.sleep(2)

client.query(regulated_entity_exemption_compliance_deadlines.replace('$file_path', ""))
time.sleep(2)

client.close(regulated_entity_filing_event.replace('$file_path', ""))
time.sleep(2)
